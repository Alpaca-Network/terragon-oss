    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=bottom]:shadow-[0_-4px_20px_rgba(0,0,0,0.1)] dark:data-[vaul-drawer-direction=bottom]:shadow-[0_-4px_30px_rgba(0,0,0,0.3)]",
        ...
        {...props}
      >
        {/* Futuristic gradient handle for bottom drawer */}
        <div className="mx-auto mt-3 hidden h-1.5 w-12 shrink-0 rounded-full bg-gradient-to-r from-muted via-muted-foreground/30 to-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
